...
class UserProfile(object):
    ...
    def __init__(self, company_name=None, email=None, email_alert_pref=None, first_name=None, last_name=None, phone=None, picture=None, push_alert_pref=None, sms_alert_pref=None, sms_sig_threshold=None, subscribed_crops=None, subscription_access_level=None, user_id=None):
        """
    ...
    def email_alert_pref(self):
        """
        Gets the email_alert_pref of this UserProfile.
        User email alert preferences

        :return: The email_alert_pref of this UserProfile.
        :rtype: str
        """
    ...
    def email_alert_pref(self, email_alert_pref):
        """
        Sets the email_alert_pref of this UserProfile.
        User email alert preferences

        :param email_alert_pref: The email_alert_pref of this UserProfile.
        :type: str
        """
    ...
    def phone(self):
        """
        Gets the phone of this UserProfile.
        Phone number of the user

        :return: The phone of this UserProfile.
        :rtype: str
        """
        return self._phone
    ...
    def phone(self, phone):
        ...
        :param phone: The phone of this UserProfile.
        :type: str
        """
    ...
    def picture(self):
        """
        Gets the picture of this UserProfile.
        Image URL of the user.

        :return: The picture of this UserProfile.
        :rtype: str
        """
    ...
    def picture(self, picture):
        """
        Sets the picture of this UserProfile.
        Image URL of the user.

        :param picture: The picture of this UserProfile.
        :type: str
        """
    ...
    def push_alert_pref(self):
        """
        Gets the push_alert_pref of this UserProfile.
        User web push alert preferences

        :return: The push_alert_pref of this UserProfile.
        :rtype: str
        """
    ...
    def push_alert_pref(self, push_alert_pref):
        """
        Sets the push_alert_pref of this UserProfile.
        User web push alert preferences

        :param push_alert_pref: The push_alert_pref of this UserProfile.
        :type: str
        """
    ...
    def sms_alert_pref(self):
        """
        Gets the sms_alert_pref of this UserProfile.
        User sms alert preferences

        :return: The sms_alert_pref of this UserProfile.
        :rtype: str
        """
    ...
    def sms_alert_pref(self, sms_alert_pref):
        """
        Sets the sms_alert_pref of this UserProfile.
        User sms alert preferences

        :param sms_alert_pref: The sms_alert_pref of this UserProfile.
        :type: str
        """
    ...
    def sms_sig_threshold(self):
        """
        Gets the sms_sig_threshold of this UserProfile.
        User sms alert significance threshold

        :return: The sms_sig_threshold of this UserProfile.
        :rtype: int
        """
    ...
    def sms_sig_threshold(self, sms_sig_threshold):
        """
        Sets the sms_sig_threshold of this UserProfile.
        User sms alert significance threshold

        :param sms_sig_threshold: The sms_sig_threshold of this UserProfile.
        :type: int
        """
    ...
    def subscribed_crops(self):
        """
        Gets the subscribed_crops of this UserProfile.

        :return: The subscribed_crops of this UserProfile.
    ...
    def subscribed_crops(self, subscribed_crops):
        """
        Sets the subscribed_crops of this UserProfile.

        :param subscribed_crops: The subscribed_crops of this UserProfile.
    ...
    def subscription_access_level(self):
        """
        Gets the subscription_access_level of this UserProfile.
        Subscription level of the user

        :return: The subscription_access_level of this UserProfile.
        :rtype: str
        """
    ...
    def subscription_access_level(self, subscription_access_level):
        """
        Sets the subscription_access_level of this UserProfile.
        Subscription level of the user

        :param subscription_access_level: The subscription_access_level of this UserProfile.
        :type: str
        """
